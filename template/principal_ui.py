...
class Ui_principal(object):
    def setupUi(self, principal):
        ...
        self.actionCadastrar_user = QAction(principal)
        self.actionCadastrar_user.setObjectName(u"actionCadastrar_user")
        self.actionCadastrar_user.setIcon(icon1)
        self.actionApagar_user = QAction(principal)
        self.actionApagar_user.setObjectName(u"actionApagar_user")
        self.actionApagar_user.setIcon(icon2)
        self.actionAtualizar_user = QAction(principal)
        self.actionAtualizar_user.setObjectName(u"actionAtualizar_user")
        self.actionAtualizar_user.setIcon(icon3)
        self.actionRefresh_user = QAction(principal)
        self.actionRefresh_user.setObjectName(u"actionRefresh_user")
        self.actionRefresh_user.setIcon(icon4)
...
"border-color: rgb(66, 66, 66);")
        ...
        self.menuUsu_rio = QMenu(self.menubar)
        self.menuUsu_rio.setObjectName(u"menuUsu_rio")
        ...
        self.menuUsu_rio.addAction(self.actionCadastrar_user)
        self.menuUsu_rio.addAction(self.actionApagar_user)
        self.menuUsu_rio.addAction(self.actionAtualizar_user)
        self.menuUsu_rio.addAction(self.actionRefresh_user)
    ...
    def retranslateUi(self, principal):
        ...
        self.actionCadastrar_user.setText(QCoreApplication.translate("principal", u"Cadastrar", None))
        self.actionApagar_user.setText(QCoreApplication.translate("principal", u"Apagar", None))
        self.actionAtualizar_user.setText(QCoreApplication.translate("principal", u"Atualizar", None))
        self.actionRefresh_user.setText(QCoreApplication.translate("principal", u"Refresh", None))
        self.label.setText("")
        ...
        self.menuUsu_rio.setTitle(QCoreApplication.translate("principal", u"Usu\u00e1rio", None))
