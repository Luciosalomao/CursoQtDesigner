...
class Ui_principal(object):
    def setupUi(self, principal):
        ...
        self.actionGerenciar_user = QAction(principal)
        self.actionGerenciar_user.setObjectName(u"actionGerenciar_user")
        icon5 = QIcon()
        icon5.addFile(u":/icones/user.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionGerenciar_user.setIcon(icon5)
...
"border-color: rgb(66, 66, 66);")
        ...
        self.menuUsu_rio.addAction(self.actionGerenciar_user)
    ...
    def retranslateUi(self, principal):
        ...
        self.actionGerenciar_user.setText(QCoreApplication.translate("principal", u"Gerenciar", None))
